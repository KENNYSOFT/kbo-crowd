...
예측을 거의 나아지게 하지 않는다. 비는 관중을 분명히 깎지만 그 경로가 거의 당일
판매라서, 일주일 전에 팔리는 표는 날씨를 보고 팔리는 것이 아니기 때문이다.
리드타임도 생각보다 싸다. 일주일을 물러서도 브라이어가 0.1491 에서 0.1513 으로
오를 뿐인데, 순위가 그 사이 평균 0.7계단밖에 움직이지 않아서다. 연승은 3.0경기
움직이지만 그 변동까지 들어간 결과가 이 정도다.
